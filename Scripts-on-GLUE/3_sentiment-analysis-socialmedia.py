...
# ===== CONFIG PATH =====
INPUT_PATH = "s3://bigdata-project-group/data/processed-data/etl-outputs/social_media_posts/after_cleansing/2025-05/"
OUTPUT_PATH = "s3://bigdata-project-group/data/processed-data/model-outputs/sentiment-analysis/"
SENTIMENT_ENDPOINT = "http://ec2-13-218-205-51.compute-1.amazonaws.com/predict"  # ← เปลี่ยนตามจริง
